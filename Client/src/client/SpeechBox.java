...
public class SpeechBox extends HBox {
    ...
    private final Color DEFAULT_SENDER_COLOR = Color.rgb(103, 95, 166);
    private final Color DEFAULT_RECEIVER_COLOR = Color.rgb(119, 169, 53);
    ...
    public SpeechBox(String message, boolean direction) {
